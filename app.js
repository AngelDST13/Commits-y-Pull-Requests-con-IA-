document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- DICCIONARIO Y LÓGICA CÓDIGO MORSE ---
  ...
  if (convertMorseBtn) {
    convertMorseBtn.addEventListener('click', () => {
      ...
      if (!input) return showAlert('Por favor ingresa un texto o código Morse válido.');
  ...
  if (convertPressureBtn) {
    ...
    convertPressureBtn.addEventListener('click', () => {
      ...
      if (isNaN(val)) return showAlert('Por favor ingresa un valor numérico válido.');
